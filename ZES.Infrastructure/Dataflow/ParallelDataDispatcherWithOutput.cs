...
namespace ZES.Infrastructure.Dataflow
{
  ...
  /// </remarks>
  public abstract class ParallelDataDispatcherWithOutput<TKey, TIn, TOut> : Dataflow<TIn, TOut>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ParallelDataDispatcherWithOutput{TKey,TIn,TOut}"/> class.
    /// </summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ParallelDataDispatcherWithOutput{TKey,TIn,TOut}"/> class.Construct an DataDispatcher instance</summary>
    /// <param name="dispatchFunc">The dispatch function</param>
    ...
    public ParallelDataDispatcherWithOutput<TKey, TIn, TOut> OnError(Action action)
    {
