...
namespace ZES.Infrastructure
{
    ...
    public class RecordLog : IRecordLog
    {
        ...
        /// <inheritdoc />
        public void AddMutation(string mutation, Time timestamp = default)
        {
        ...
        public async Task<IScenario> Load(string logFile)
        {
            ...
            var scenario = JsonConvert.DeserializeObject<Scenario>(s, new JsonSerializerSettings()
                .ConfigureForTime());
            return scenario;
        }
        ...
        public class Scenario : IScenario
        {
            ...
            public class Mutation : IScenarioMutation
            {
                ...
                public Mutation(string graphQl, Time timestamp)
                {
                    GraphQl = graphQl;
                    Timestamp = timestamp;
                }
