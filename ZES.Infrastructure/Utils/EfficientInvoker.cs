...
namespace ZES.Infrastructure.Utils
{
    ...
    internal sealed class EfficientInvoker
    {
        ...
        public static EfficientInvoker ForMethodInfo(Type type, MethodInfo method)
        {
            if (type == null || method == null)
                throw new ArgumentNullException();
            
            var key = new MethodKey(type, $"{method.Name}_{method.GetParameters().First().ParameterType.Name}");
